...
The goal is to create a readable record of what User and Claude discussed and accomplished — not a verbatim transcript, but a structured summary that's useful for future reference.
...
User: {One sentence summary of request}
...
- Do NOT use bold markup (`**`) on User/Claude names — keep them plain text
